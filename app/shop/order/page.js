      ...
      <section className="px-4 md:px-6 py-10 ">
        <div className="flex flex-col container mx-auto max-w-screen-xl min-h-screen gap-6">
          ...
          <div className="flex justify-between gap-5">
            <div className="bg-card rounded-lg p-6 flex-4">
            ...
            <div className="bg-card rounded-lg p-6 flex-1 h-50 text-accent-foreground">
              <span className="flex justify-end text-right p-2">
                共有{itemCount}件商品
              </span>
