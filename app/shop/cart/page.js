      ...
      <section className="px-4 md:px-6 py-10">
        <div className="flex flex-col container mx-auto max-w-screen-xl min-h-screen gap-6">
          ...
          <Table className="w-full table-fixed">
            <TableHeader className="border-b-2 border-foreground">
              <TableRow className="text-lg">
                ...
                <TableHead className="font-bold w-1/4 text-right hidden md:table-cell">
                  總計
                </TableHead>
              </TableRow>
            </TableHeader>
          ...
          <div className="flex flex-col">
            <span className="text-muted text-base text-right p-2">
              共有3件商品
            </span>
            <Table className="table-fixed flex justify-end">
              <TableBody>
                ...
                <TableRow className="border-b">
                  ...
                  <TableCell className="text-base">未選擇</TableCell>
                </TableRow>
                <TableRow>
