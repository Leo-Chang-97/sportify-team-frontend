 ...
 */
export const getLessonImageUrls = (images) => {
  if (!images || !Array.isArray(images)) return []

  return images
    .sort((a, b) => a.order - b.order) // 按照 order 排序
    .map((img) => getLessonImageUrl(img.url))
}
