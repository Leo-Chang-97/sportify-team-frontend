...
export const fetchCenterOptions = async (params = {}, options = {}) => {
...
export const fetchCourtOptions = async (params = {}, options = {}) => {
  const query = new URLSearchParams(
    Object.fromEntries(
      Object.entries(params).filter(([, v]) => v !== undefined && v !== '')
    )
...
// 批次設定價格（依條件）
export const batchSetCourtTimeSlotPrice = async (data, options = {}) => {
